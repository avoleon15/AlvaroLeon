...
export const hero = {
  name: 'Alvaro Leon',
  title: 'Junior Software Developer — React & JavaScript',
...
export const projects = [
  {
    ...
    images: [
      '/assets/Asdrubal-screen1.png',
      '/assets/Asdrubal-screen2.png',
      '/assets/Asdrubal-screen3.png',
      '/assets/Asdrubal-screen4.png',
      '/assets/Asdrubal-screen5.png',
    ],
  ...
  },
  {
    ...
    images: [
      '/assets/Luxe-screen1.png',
      '/assets/Luxe-screen2.png',
      '/assets/Luxe-screen3.png',
      '/assets/Luxe-screen4.png',
      '/assets/Luxe-screen5.png',
      '/assets/Luxe-screen6.png',
      '/assets/Luxe-screen7.png',
    ],
  ...
  },
  {
    ...
    images: [
      '/assets/Quetzalink-screen1.png',
      '/assets/Quetzalink-screen2.png',
      '/assets/Quetzalink-screen3.png',
      '/assets/Quetzalink-screen4.png',
      '/assets/Quetzalink-screen5.png',
      '/assets/Quetzalink-screen6.png',
      '/assets/Quetzalink-screen7.png',
      '/assets/Quetzalink-screen8.png',
    ],
  ...
  },
  {
    ...
    images: [
      '/assets/vyn-screen1.png',
      '/assets/vyn-screen2.png',
      '/assets/vyn-screen3.png',
      '/assets/vyn-screen4.png',
      '/assets/vyn-screen5.png',
      '/assets/vyn-screen6.png',
    ],
  ...
  },
  {
    ...
    images: [
      '/assets/CR-screen1.png',
      '/assets/CR-screen2.png',
      '/assets/CR-screen3.png',
    ],
